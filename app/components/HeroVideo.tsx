...
export default function Hero3D() {
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      {/* Branding */}
      <div className="absolute top-6 left-6 text-white text-2xl font-[Exo] tracking-wide bg-black px-4 py-2 rounded-lg shadow-lg">
        Silverine
      </div>
      ...
      <div className="absolute top-20 left-6 space-y-4 max-w-xs">
        <div className="bg-white/20 backdrop-blur-md p-4 rounded-2xl shadow-lg text-black">
          <h3 className="text-xl font-[Exo] mb-4">Whitepaper</h3>
          <p className="text-xs text-gray-500 mb-4">
            Evo 2 is a Deep Learning model designed to process genome
            sequence data on a large scale. This algorithm uses deep learning
            techniques to identify mutation patterns and determine the
            correlation between genetic changes and antibiotic resistance
            levels.
          </p>
          <a
      ...
      <div className="absolute top-1/2 right-6 transform -translate-y-1/2 bg-white/20 backdrop-blur-md p-4 rounded-2xl shadow-lg max-w-xs text-black">
        <h2 className="text-2xl font-[Exo]">Silverine Labs</h2>
      ...
      <div className="absolute top-80 left-6 space-y-4 max-w-xs">
        ...
        <div className="space-y-4">
          {/* Fase 1 */}
          <div className="bg-white/20 backdrop-blur-md p-4 rounded-2xl shadow-lg text-black">
            <h3 className="text-xl font-[Exo] mb-2">Phase 1 - Q1 2025</h3>
          ...
          {/* Fase 2 */}
          <div className="bg-white/20 backdrop-blur-md p-4 rounded-2xl shadow-lg text-black">
            <h3 className="text-xl font-[Exo] mb-2">Phase 2 - Q2 2025</h3>
            <p className="text-sm text-gray-500">
          ...
          <div className="bg-teal-500 backdrop-blur-md p-4 rounded-2xl shadow-lg text-white group">
            <h3 className="text-xl font-[Exo] mb-2 ">Phase 3 - Q3 2025</h3>
          ...
          {/* Fase 4 */}
          <div className="bg-white/20 backdrop-blur-md p-4 rounded-2xl shadow-lg text-black">
            <h3 className="text-xl font-[Exo] mb-2">Phase 4 - Q4 2025</h3>
